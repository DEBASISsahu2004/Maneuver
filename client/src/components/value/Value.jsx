...
const valueCards = [
    {
        ...
        desc: 'Every project starts with clarity. We define your goals, map the user journey, and design with precision - not assumptions.',
        animation: (
            <>
    ...
    },
    {
        ...
        desc: `We're not here to just execute. We bring insight, challenge the obvious, and push for what makes your product unforgettable.`,
        animation: (
            <>
    ...
    },
    {
        ...
        desc: 'We craft clean, brand-aligned visuals that guide attention, build trust, and elevate every click and scroll.',
        animation: (
            <>
    ...
    },
    {
        ...
        desc: 'We move fast, but never loose. Sharp code, seamless handoffs, and a delivery process that respects both detail and deadline.',
        animation: (
            <>
                ...
                <div className={styles.value_card_animation_main}>
                    ...
                    <img className={styles.value_card_four_notification2} src={NotiTwo4} alt="notification 2" />
                </div>
            </>
        ),
    },
    {
        ...
        desc: `You're part of this. We work transparently, speak plainly, and build on shared vision — not guesswork.`,
        animation: (
            <>
    ...
    },
    {
        ...
        desc: `Our work doesn't end at launch. We stay close, fine-tune when needed, and keep your product running like it should.`,
        animation: (
            <>
