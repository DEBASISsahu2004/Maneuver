...
import BlockOne from '../../assets/icons/block-one.svg'
import BlockTwo from '../../assets/icons/block-two.svg'
import BlockThree from '../../assets/icons/block-three.svg'
import MiddleBlockCircle from '../../assets/icons/middle-block-circle.svg'
  ...
  return (
    <section id="services" className={styles.service_container}>
      ...
      <div className={styles.service_content_wrapper}>
        <div className={styles.service_row_one}>
          <div className={styles.service_card_one}>
          ...
          <div className={styles.service_card_two}>
            <div className={styles.service_card_animation}>
              <div className={styles.service_card_animation_star}>
                <img src={Star} alt="star circle" />
              </div>
              ...
              <div className={styles.service_card_animation_icons}>
                ...
                <div className={styles.service_card_icon}>
                  <img src={LottieLogo} alt="Lottie Logo" />
                </div>
                <div className={styles.service_card_icon}>
          ...
          <div className={styles.service_card_three}>
            <div className={styles.service_card_content}>
            ...
            <div className={styles.service_card_animation}>
              <img className={styles.stride_home_img} src={StrideHome} alt="Stride Home" />
            </div>
          </div>
        </div>

        <div className={styles.service_row_two}>
          <div className={styles.service_card_one}>
            <div className={styles.service_card_content}>
            ...
            <div className={styles.service_card_animation}>
              <img className={styles.block_one} src={BlockOne} alt="block 1" />
              <div className={styles.middle_block_wrapper}>
                <img className={styles.circle} src={MiddleBlockCircle} alt="circle" />
                <img className={styles.block_two} src={BlockTwo} alt="block 2" />
              </div>
              <img className={styles.block_three} src={BlockThree} alt="block 3" />
            </div>
          </div>
          ...
          <div className={styles.service_card_two}>
            ...
            <div className={`${styles.service_card_animation} ${styles.service_card_animation_two}`}>

              <div className={`${styles.noti_wrapper} ${styles.mnver_noti}`}>
              ...
              <div className={`${styles.noti_wrapper} ${styles.avatar1_noti}`}>
              ...
              <div className={`${styles.noti_wrapper} ${styles.avatar2_noti}`}>
